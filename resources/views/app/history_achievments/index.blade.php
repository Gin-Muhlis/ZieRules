    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.catatan_scan_prestasi.index_title')
                </h4>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('history-achievments.edit', $historyAchievment) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <a
                                        href="{{ route('history-achievments.show', $historyAchievment) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <form
                                        action="{{ route('history-achievments.destroy', $historyAchievment) }}"
                                        method="POST"
