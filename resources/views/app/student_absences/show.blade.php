    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">
                ...
                ></a>
                @lang('crud.absensi_siswa.show_title')
            </h4>

            <div class="mt-4">
                <div class="mb-4">
                    <h5>@lang('crud.absensi_siswa.inputs.date')</h5>
                    <span>{{ $studentAbsence->date ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.absensi_siswa.inputs.student_id')</h5>
                    <span
                ...
                <div class="mb-4">
                    <h5>@lang('crud.absensi_siswa.inputs.presence_id')</h5>
                    <span
                ...
                <div class="mb-4">
                    <h5>@lang('crud.absensi_siswa.inputs.time')</h5>
